...
syn_logger = SynergosLogger(server=CONST_WORKER['SERVER'], port=CONST_WORKER['PORT'], logging_level=logging.DEBUG, debugging_fields=True, file_path=file_path, logger_name=CONST_WORKER['LOGGER'])
