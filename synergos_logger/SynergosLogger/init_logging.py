...
syn_logger = SynergosLogger(server=CONST_COMPONENT['SERVER'], port=CONST_COMPONENT['PORT'], 
                            logging_level=logging.DEBUG, debugging_fields=True, 
                            logger_name=CONST_COMPONENT['LOGGER'], logging_variant=LOGGING_VARIANT)

# If there are logs to be censored, pass in optional argument "censor_keys" 
# to censor sensitive log messages e.g. sys_logger.initialize_structlog(censor_keys=["password", "username"])
